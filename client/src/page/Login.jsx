            ...
            <div className=" flex flex-col gap-8">
              <h1 className=" m-auto text-2xl font-bold">Welcome Back</h1>
                ...
                <form onSubmit={submit} >
                  ...
                  <input required className=" mt-2 w-full  border  border-gray-400 rounded p-1 outline-none " type="password" placeholder=" Enter your Password" value={password} onChange={(e)=>setPassword(e.target.value)} />
                  <div>
